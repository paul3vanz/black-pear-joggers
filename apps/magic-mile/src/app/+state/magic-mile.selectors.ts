...
const getLoaded = createSelector(
  getMagicMileState,
  (state: MagicMileState) => state.loaded
);
const getError = createSelector(
  getMagicMileState,
  (state: MagicMileState) => state.error
);

const getAllMagicMile = createSelector(
  getMagicMileState,
  getLoaded,
...
const getSelectedId = createSelector(
  getMagicMileState,
  (state: MagicMileState) => state.selectedId
);
const getSelectedMagicMile = createSelector(
  getAllMagicMile,
  getSelectedId,
  (magicMile, id) => {
