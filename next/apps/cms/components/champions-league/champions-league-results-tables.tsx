...
const results = [
    ...
    results: {
      men: {
        ...
        topTen: [
          { position: 1, name:' Richard Drewett', races: 10, points: 289 },
          { position: 2, name:' Christopher Berry', races: 10, points: 258 },
          { position: 3, name:' Adam Knights', races: 9, points: 255 },
          { position: 4, name:' Tim Jenkins', races: 11, points: 241 },
          { position: 5, name:' George Cruchley-Fuge', races: 12, points: 232 },
          { position: 6, name:' Matthew Capel', races: 10, points: 203 },
          { position: 7, name:' Paul Naughton', races: 5, points: 134 },
          { position: 8, name:' Matt Pilott', races: 3, points: 90 },
          { position: 9, name:' Robbie Caskey', races: 4, points: 87 },
          { position: 10, name:' John Firth', races: 3, points: 85 },
        ],
      },
      women: {
        url: 'https://docs.google.com/spreadsheets/d/1tSpS2wfmBQ-2oLfRxxE_800sFX5n5o7DqTakZzMh4no/edit?gid=6426148#gid=6426148',
        topTen: [
          { position: 1, name:' Katie Gromski', races: 11, points: 261 },
          { position: 2, name:' Lauren Cruchley-Fuge', races: 12, points: 238 },
          { position: 3, name:' Deborah Band', races: 10, points: 233 },
          { position: 4, name:' Lucy Capel', races: 10, points: 219 },
          { position: 5, name:' Anya Lees', races: 10, points: 218 },
          { position: 6, name:' Diana Fox', races: 7, points: 199 },
          { position: 7, name:' Rachael Lewis', races: 5, points: 137 },
          { position: 8, name:' Samantha McClory', races: 8, points: 152 },
          { position: 9, name:' Gail Berry', races: 5, points: 93 },
          { position: 10, name:' Bronwen Mansel', races: 4, points: 96 },
        ],
      },
    },
  },
